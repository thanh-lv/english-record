...
export function useVocabulary(t: any) {
  ...
  const fetchCards = async (setId: string) => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Fetch cards error', err);
    } finally {
  ...
  const handleCreateSet = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error creating vocab set', err);
  ...
  const handleUpdateSet = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error updating vocab set', err);
  ...
  const handleDeleteSet = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error deleting vocab set', err);
  ...
  const autoGenIpa = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error generating IPA', err);
    } finally {
      setIpaLoading(false);
    }
  };
  ...
  const uploadCardImage = async (file: File) => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Upload card image error', err);
  ...
  const handleAddCard = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error creating card', err);
  ...
  const handleDeleteCard = async () => {
    ...
    try {
      ...
      loggerService.error('useVocabulary', 'Error deleting card', err);
