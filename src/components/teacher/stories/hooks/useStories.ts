...
export function useStories(t: any) {
  ...
  const saveEditStory = async () => {
    ...
    try {
      ...
      loggerService.error('useStories', 'Error updating story', err);
  ...
  const confirmDeleteStory = async () => {
    ...
    try {
      ...
      loggerService.error('useStories', 'Error deleting story', err);
  ...
  const handleManualSave = async () => {
    ...
    try {
      ...
      loggerService.error('useStories', 'Error saving manual story', err);
  ...
  const handleGenerateAiStory = async () => {
    ...
    try {
      ...
      loggerService.error('useStories', 'Error generating AI story', err);
  ...
  const handleSaveAiStory = async () => {
    ...
    try {
      ...
      loggerService.error('useStories', 'Error saving AI story', err);
