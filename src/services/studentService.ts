...
export const studentService = {
  ...
  async createStudent(payload: CreateStudentPayload): Promise<UserProfile> {
    return withServiceHandling('studentService', 'createStudent', async () => {
  ...
  async updateStudent(id: string, payload: UpdateStudentPayload): Promise<UserProfile> {
    return withServiceHandling('studentService', 'updateStudent', async () => {
  ...
  async resetStudentPassword(id: string, password: string): Promise<void> {
    return withServiceHandling('studentService', 'resetStudentPassword', async () => {
  ...
  async deleteStudent(id: string): Promise<void> {
    return withServiceHandling('studentService', 'deleteStudent', async () => {
