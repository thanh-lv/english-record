...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FFFDF6] via-[#F4F9FF] to-[#FFF5F6] text-slate-800 font-sans selection:bg-pink-100">
      <header className="bg-white/80 backdrop-blur-md shadow-sm px-6 py-4 flex justify-between items-center sticky top-0 z-10 border-b-4 border-[#FFF0F0]">
        <h1 className="text-2xl md:text-3xl font-extrabold text-[#1E88E5] flex items-center gap-2 tracking-wider">
          <span className="p-2 bg-[#E3F2FD] rounded-2xl inline-block shadow-inner">
            <Mic className="text-[#1E88E5]" />
          </span>
          SpeakwithMsMy
        </h1>
        {userProfile && (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 px-4 py-2 rounded-full border-2 border-rose-200 transition-all shadow-sm"
            >
